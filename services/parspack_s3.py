...
from boto3.s3.transfer import TransferConfig  # اضافه کردن این ماژول
...
def upload_to_s3(file_path: str, object_name: str = None) -> str:
    ...
    transfer_config = TransferConfig(
        ...
        max_concurrency=5,  # کاهش به 5 برای جلوگیری از درگیری بیش از حد CPU
        multipart_chunksize=8 * 1024 * 1024,
        use_threads=True,
    )

    try:
        # آپلود فایل با تنظیمات انتقال (TransferConfig)
        s3.upload_file(file_path, ARVAN_BUCKET, object_name, Config=transfer_config)
